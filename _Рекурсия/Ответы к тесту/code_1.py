...
res_lines_supp = copy.deepcopy(res_lines)
print(res_lines)
...
def matching():
    ...
    # print(res_lines)
    for i in range(q):
        for k, el in enumerate(res_lines_supp):
            if el[0][i] == right_answ:
                ...
                if el[2] > el[1]:
                    ...
                    if el[3] > q - el[1]:
                        ...
                        if flag_w > 1:
                            el[3] -= 1
                            res_lines_supp[f][3] -= 1
                            res_lines_supp[0][2] -= 1
                            if start == '+':
                                start = '-'
                                right_answ = '-'
                            else:
                ...
                if el[3] > q - el[1]:
                    ...
                    if el[2] > el[1]:
                        ...
                        if flag_w > 1:
                            el[2] -= 1
                            res_lines_supp[f][2] -= 1
                            res_lines_supp[0][3] -= 1
                            if start == '+':
                                start = '-'
                                right_answ = '-'
                            else:
